...
function role.init()
    ...
    data.accdb = skynet.call(master, "lua", "get", "account")
    data.userdb = skynet.call(master, "lua", "get", "user")
    data.namedb = skynet.call(master, "lua", "get", "name")
    data.infodb = skynet.call(master, "lua", "get", "info")
    local account = skynet.call(data.accdb, "lua", "findOne", data.userid)
    if account then
